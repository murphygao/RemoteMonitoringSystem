...
{
    public class KTBMobileMKTAdaptorService
    {
        ...
        MobileMKTAdaptorSoapClient service;

        #region Constructor

        public KTBMobileMKTAdaptorService()
            : this(null)
        {
        }

        public KTBMobileMKTAdaptorService(string urlWebService)
        {
        ...
        public MobileMKTAdaptorSoapClient Service
        {
            get { return service; }
            set { service = value; }
        }
        ...
        private void Initialize(string urlWebService)
        {
            try
            {
                ...
                service.Endpoint.Address = new EndpointAddress(webServicURL);
                if (timeOut != null)
                    service.Endpoint.Binding.SendTimeout = new TimeSpan(0, 0, timeOut.Value);

                var b = service.Endpoint.Binding as System.ServiceModel.BasicHttpBinding;
