...
namespace RMS.Centralize.WebService.Proxy
{
    public class MonitoringService
    {
        ...
        private void Initialize(string urlWebService)
        {
            try
            {
                try
                {
                    if (urlWebService != null)
                        ...
                        webServicURL = ConfigurationManager.AppSettings["WebServicURL_MonitoringService"];
            ...
            {
                throw new Exception("MonitoringService - Initialize() ctor failed. " + ex.Message, ex);
            }
        }
