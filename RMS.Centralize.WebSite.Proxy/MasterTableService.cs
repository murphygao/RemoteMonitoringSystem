...
namespace RMS.Centralize.WebSite.Proxy
{
    public class MasterTableService
    {
        ...
        MasterTableServiceClient _MasterTableService;
        ...
        public MasterTableService(string urlWebService)
        {

            try
            {
                _MasterTableService = new MasterTableServiceClient();
                Initialize(urlWebService);
            }
            catch (Exception ex)
            {
                _MasterTableService = null;
                throw new RMSWebException(this, "0500", "MasterTableService ctor failed. " + ex.Message, ex, false);
            }
        }
        ...
        public MasterTableServiceClient masterTableService
        {
            get { return _MasterTableService; }
            set { _MasterTableService = value; }
        }
            ...
            try
            {
                try
                {
                    if (urlWebService != null)
                        ...
                        webServicURL = ConfigurationManager.AppSettings["RMS.WebServicURL_MasterTableService"];
                ...
                _MasterTableService.Endpoint.Address = new EndpointAddress(webServicURL);
                if (timeOut != null)
                    _MasterTableService.Endpoint.Binding.SendTimeout = new TimeSpan(0, 0, timeOut.Value);

                var b = _MasterTableService.Endpoint.Binding as System.ServiceModel.BasicHttpBinding;
