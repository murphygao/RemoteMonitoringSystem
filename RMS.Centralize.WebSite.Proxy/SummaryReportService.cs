...
namespace RMS.Centralize.WebSite.Proxy
{
    public class SummaryReportService
    {
        ...
        private void Initialize(string urlWebService)
        {
            try
            {
                try
                {
                    if (urlWebService != null)
                        ...
                        webServicURL = ConfigurationManager.AppSettings["WebServicURL_SummaryReportService"];
            ...
            {
                throw new Exception("SummaryReportService - Initialize() ctor failed. " + ex.Message, ex);
            }
        }
