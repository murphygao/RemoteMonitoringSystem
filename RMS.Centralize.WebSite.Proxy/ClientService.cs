...
namespace RMS.Centralize.WebSite.Proxy
{
    public class ClientService
    {
        ...
        ClientServiceClient _clientService;
        ...
        public ClientServiceClient clientService
        {
            ...
            try
            {
                try
                {
                    if (urlWebService != null)
                        ...
                        webServicURL = ConfigurationManager.AppSettings["RMS.WebServicURL_ClientService"];
                ...
                _clientService.Endpoint.Address = new EndpointAddress(webServicURL);
                if (timeOut != null)
                    _clientService.Endpoint.Binding.SendTimeout = new TimeSpan(0, 0, timeOut.Value);

                var b = _clientService.Endpoint.Binding as System.ServiceModel.BasicHttpBinding;
