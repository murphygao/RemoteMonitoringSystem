<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeverityLevelList.aspx.cs" Inherits="RMS.Centralize.Website.Monitoring.SeverityLevelList" %>
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jarviswidget" id="severitylevel-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                        <!-- widget options:
                                ...
                                <form id="searhForm" class="smart-form">
                                    <fieldset>
                                        <section class="col col-md-6 col-xs-12">
                                            <label class="input">
                                                <input type="text" class="input-sm" id="txtSeverityLevel" placeholder="Level Code or Level Name" />
                                            </label>
                                        </section>
            ...
            <div class="row">
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark" id="severitylevel-id-1"
                        data-widget-togglebutton="false"
                        data-widget-colorbutton="false"
                        data-widget-editbutton="false"
                        data-widget-deletebutton="false"
                                ...
                                <table id="dt_basic" class="table table-striped table-hover" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Level Code</th>
                                            <th>Level Name</th>
                                            <th style="text-align: center">Order List</th>
                                            <th style="text-align: center">Active List</th>
                                            <th>Default Action Profile</th>
        ...
        <div class="row form-horizontal">
            <div class="col-xs-12">
                <div class="form-group">
                    <div class="col-md-8">
                        <a class="btn btn-primary" id="aNew" href="SeverityLevelEdit.aspx">Add New</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#dt_basic').dataTable({
                ...
                "aaSorting": [[3, "asc"]],
                "iDisplayLength": 50,
                "sAjaxSource": "<%= HttpContext.Current.Request.ApplicationPath %>/Monitoring/SeverityLevel/Search/",
                "fnServerData": function (sSource, aoData, fnCallback) {
                    aoData.push({ "name": "severityLevel", "value": $('#txtSeverityLevel').val() });
                ...
                "aoColumns": [
                    ...
                    },
                    {
                        ...
                        "sClass": "center",
                        "fnRender": function (oObj) {
                            if (oObj.aData["ActionRepeatable"]) {
                                return '<span class="label label-success">ON</span>';
                            } else {
                                return '<span class="label label-danger">OFF</span>';
                            }
                    ...
                    {
                        "mDataProp": "ActionRepeatInterval",
                        "bSearchable": false,
                        "bSortable": false,
                        "sClass": "center",
                        "sWidth": "50"
                    },
                    {
                        ...
                        "sWidth": "80",
                        "fnRender": function (oObj) {
                            return oObj.aData["ColorTagStart"] + oObj.aData["ColorCode"] + oObj.aData["ColorTagEnd"];
                        }
                    },
                    {
                        "mData": null,
                        ...
                        "fnRender": function (oObj) {
                            var str = '';
                            if (oObj.aData["SeverityLevelId"] >= 10) {
                                str += '<a id="edit_item_' + oObj.aData["SeverityLevelId"] + '" class="btn btn-primary btn-xs" href="javascript:toEditRow(' + oObj.aData["SeverityLevelId"] + ')"><i class="glyphicon glyphicon-edit"></i></a>';
                                str += '&nbsp;<a id="del_item_' + oObj.aData["SeverityLevelId"] + '" class="btn btn-danger btn-xs" href="javascript:deleteRow(' + oObj.aData["SeverityLevelId"] + ');"><i class="glyphicon glyphicon-trash"></i></a>';
                            }
                            return str;
                        }
                    }
            ...
            $.SmartMessageBox({
                ...
                if (ButtonPressed === "Yes") {
                    $.ajax({
                        ...
                        "url": "<%= HttpContext.Current.Request.ApplicationPath %>/Monitoring/SeverityLevel/Delete",
        ...
        function toEditRow(id) {
            ...
            post_to_url("SeverityLevelEdit.aspx", params, null);
        }
