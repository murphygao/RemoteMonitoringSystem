...
namespace RMS.Monitoring.Device.Keyboard
{
    public class KeyboardService
    {
        ...
        public KeyboardService(string brand, string model, string deviceManagerName, string deviceManagerID, ClientResult clientResult)
        {
            try
            {
            ...
            {
                throw new RMSAppException(this, "0500", "KeyboardService failed. " + ex.Message, ex, false);
            }
        }
