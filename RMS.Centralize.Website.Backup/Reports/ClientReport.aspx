<%@ Page Title="" Language="C#" MasterPageFile="~/SmartAdmin.Master" AutoEventWireup="true" CodeBehind="ClientReport.aspx.cs" Inherits="Bootstrap.Reports.ClientReport" %>
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                ...
                                <dl class="dl-horizontal">
                                    ...
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">K201402-001</dd>
                                    <dt class="padding-15 margin-bottom-5">Client Type</dt>
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">VTM Kiosk</dd>
                                    <dt class="padding-15 margin-bottom-5">Location</dt>
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">0001 - เยาวราช</dd>
                                    <dt class="padding-15 margin-bottom-5">Installation Date</dt>
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">04 February 2014</dd>
                                    <dt class="padding-15 margin-bottom-5">Last Update</dt>
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">01 March 2014</dd>
                                    <dt class="padding-15 margin-bottom-5">Device Profile</dt>
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">VTM Kiosk v001</dd>
                                    <dt class="padding-15 margin-bottom-5">Contact Detail</dt>
                                    <dd class="padding-15 margin-bottom-5 bg-color-grayLight">Tel.: 021234567<br />
                                        Mobile: 0812345678<br />
                                        b0001@ktb.co.th</dd>
                                </dl>
