...
namespace RMS.Monitoring.Device.SmartCardReader
{
    ...
    {
        private SmartCardReader _device;
        private ClientResult clientResult;

        public SmartCardReaderService(string brand, string model, string deviceManagerName, string deviceManagerID, ClientResult clientResult)
        {
            try
            {
            ...
            {
                throw new RMSAppException(this, "0500", "SmartCardReaderService failed. " + ex.Message, ex, false);
